...
void Init_base()
{
	...
	*/
	...
	anal.alignmentYRanges["R_1_F"] = Analysis::AlignmentYRange(-20.0, - 7.6, 8.0, 20.0);
	...
	alignment_c_exp_L = -0.050;
	alignment_c_exp_R = -0.150;
...
{
	// analysis settings
	anal.cut1_a = 1.; anal.cut1_c = +1.7E-6; anal.cut1_si = 9.5E-6;
	anal.cut2_a = 1.; anal.cut2_c = -0.88E-6; anal.cut2_si = 2.8E-6;
	
	anal.cut5_a = 0.107200; anal.cut5_c = -0.010; anal.cut5_si = 0.016;
	anal.cut6_a = 0.105559; anal.cut6_c = -0.002; anal.cut6_si = 0.019;

	anal.cut7_a = 168.; anal.cut7_c = +0.023; anal.cut7_si = 0.012;
...
{
	// analysis settings
	anal.cut1_a = 1.; anal.cut1_c = -1.6E-6; anal.cut1_si = 10.0E-6;
	anal.cut2_a = 1.; anal.cut2_c = -0.65E-6; anal.cut2_si = 2.8E-6;
	
	anal.cut5_a = 0.10671; anal.cut5_c = -0.009; anal.cut5_si = 0.018;
	anal.cut6_a = 0.10564; anal.cut6_c = +0.006; anal.cut6_si = 0.018;

	anal.cut7_a = 169.; anal.cut7_c = +0.022; anal.cut7_si = 0.012;
