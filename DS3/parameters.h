...
double timestamp_min = 87.7E3, timestamp_max = 99.4E3;
...
void Init_base()
{
	...
	storageDir = "root://eostotem.cern.ch//eos/totem/user/j/jkaspar/analyses/elastic/6500GeV,beta90,10sigma/DS3/";
...
void Init_45b_56t()
{
	...
	// analysis settings
	anal.cut1_a = 1.; anal.cut1_c = +0.38E-6; anal.cut1_si = 9.5E-6;
...
void Init_45t_56b()
{
	...
	// analysis settings
	anal.cut1_a = 1.; anal.cut1_c = +1.2E-6; anal.cut1_si = 10.0E-6;
