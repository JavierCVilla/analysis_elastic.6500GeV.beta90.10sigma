...
double alignment_c_exp_L=0., alignment_c_exp_R=0.;
...
void Init_base()
{
	...
	*/
	...
	anal.alignmentYRanges["L_2_F"] = Analysis::AlignmentYRange(-22.0, -10.4, 8.2, 22.0);
	anal.alignmentYRanges["L_2_N"] = Analysis::AlignmentYRange(-20.0, - 9.6, 7.4, 20.0);
	anal.alignmentYRanges["L_1_F"] = Analysis::AlignmentYRange(-19.3, - 9.2, 7.2, 19.6);
	...
	alignment_c_exp_L = -0.3;
	alignment_c_exp_R = -0.3;
...
{
	// analysis settings
	anal.cut1_a = 1.; anal.cut1_c = +5.5E-6; anal.cut1_si = 9.5E-6;
	anal.cut2_a = 1.; anal.cut2_c = -2.6E-6; anal.cut2_si = 2.8E-6;
	
	anal.cut5_a = 0.107200; anal.cut5_c = -0.010; anal.cut5_si = 0.016;
	anal.cut6_a = 0.105559; anal.cut6_c = -0.002; anal.cut6_si = 0.019;

	anal.cut7_a = 181.; anal.cut7_c = +0.014; anal.cut7_si = 0.012;
...
{
	// analysis settings
	anal.cut1_a = 1.; anal.cut1_c = +04.5E-6; anal.cut1_si = 10.0E-6;
	anal.cut2_a = 1.; anal.cut2_c = -2.1E-6; anal.cut2_si = 2.8E-6;
	
	anal.cut5_a = 0.10671; anal.cut5_c = 0.; anal.cut5_si = 0.018;
	anal.cut6_a = 0.10564; anal.cut6_c = 0.; anal.cut6_si = 0.018;

	anal.cut7_a = 179.; anal.cut7_c = +0.014; anal.cut7_si = 0.012;
