...
for (int dsi : dataSets.keys)
{
	...
	// 45 bottom - 56 top
	draw(scale(1e6, 1e6), rGetObj(top_dir+"/"+dataSets[dsi]+"/distributions_45b_56t.root", "acceptance correction/h_th_y_vs_th_x_after"), "def");
	
	// 45 top - 56 bottom
	draw(scale(1e6, 1e6), rGetObj(top_dir+"/"+dataSets[dsi]+"/distributions_45t_56b.root", "acceptance correction/h_th_y_vs_th_x_after"), "p");
