...
void Init_base()
{
	...
	storageDir = "root://eostotem.cern.ch//eos/totem/user/j/jkaspar/analyses/elastic/6500GeV,beta90,10sigma/DS4/";
...
void Init_45b_56t()
{
	...
	anal.cut2_a = 1.; anal.cut2_c = -0.07E-6; anal.cut2_si = 2.8E-6;
...
void Init_45t_56b()
{
	...
	// analysis settings
	anal.cut1_a = 1.; anal.cut1_c = +0.05E-6; anal.cut1_si = 10.0E-6;
