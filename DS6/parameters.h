...
void Init_base()
{
	...
	*/
	...
	anal.alignmentYRanges["R_2_N"] = Analysis::AlignmentYRange(-20.5, - 7.8, 8.4, 20.8);
	anal.alignmentYRanges["R_2_F"] = Analysis::AlignmentYRange(-23.0, - 8.4, 9.2, 24.0);

	alignment_c_exp_L = -0.000;
...
{
	// analysis settings
	anal.cut1_a = 1.; anal.cut1_c = +2.4E-6; anal.cut1_si = 9.5E-6;
	anal.cut2_a = 1.; anal.cut2_c = -0.8E-6; anal.cut2_si = 2.8E-6;
	
	anal.cut5_a = 0.107200; anal.cut5_c = -0.010; anal.cut5_si = 0.016;
	anal.cut6_a = 0.105559; anal.cut6_c = -0.002; anal.cut6_si = 0.019;

	anal.cut7_a = 168.; anal.cut7_c = +0.014; anal.cut7_si = 0.012;
...
{
	// analysis settings
	anal.cut1_a = 1.; anal.cut1_c = -2.4E-6; anal.cut1_si = 10.0E-6;
